...
public class DataSendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReceiveText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                connectedThread = new ConnectedThread(socket);
                connectedThread.start();
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                ...
                if (ActivityCompat.checkSelfPermission(DataSendActivity.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                    askPermission();
                }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            if (ActivityCompat.checkSelfPermission(DataSendActivity.this, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
                askPermission();
            }
